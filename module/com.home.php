<?php
$table="product WHERE stok >= 1 ORDER BY tgl_masuk DESC LIMIT 0, 10";
...
<div class="slider-area">
  ...
  <div class="block-slider block-slider4">
    <ul class="" id="bxslider-home4">
      <?php $f90=mysqli_query($con, "SELECT * From product ORDER BY id_product DESC LIMIT 0, 4");
      while ($q90=mysqli_fetch_array($f90)) {
        # code...
      ?>
      <li><img src="../../asset/img/<?php echo $q90['gambar']; ?>" style="margin-left: 100px; max-height: 400px; max-width:250px;" alt="Slide">
        <div class="caption-group">
          <h2 class="caption title">
            <span><strong><?php echo $q90['nama_product']; ?></strong></span>
          </h2>
          <h4 class="caption subtitle">Pilih Item</h4>
          <a class="caption button-radius" href="../beli/<?php echo $q90['nama_product'] ?>.html"><span class="icon"></span>Beli Sekarang</a>
        </div>
      </li>
      <?php } ?>
