      ...
      <div class="box">
        ...
        <div class="box-body">
          <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
              <?php
              $q17=mysqli_query($con, "SELECT * FROM pembayaran");
              while ($f17=mysqli_fetch_array($q17)) {
                # code...
               ?>
              <tr>
                <td><?php echo $f17['id_pembayaran'];?></td>
                <td><?php echo $f17['nama'];?></td>
                <td><?php echo $f17['bank'];?></td>
                <td> <?php echo uang($f17['total']);?></td>
                <td> <?php echo $f17['tgl_bayar'];?></td>
                <td>
                  <?php if($f17['status']== 1){ ?>
                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                  <img src="../../../../bukti/<?php echo $f17['bukti']?>" class="img img-responsive">
                              </div>
                            </div>
                          </div>
                ...
                <td>
                  <div class="row">
                    ...
                    <?php if ($f17['status']== 1) {
                      # code...
                      ?>
                      <form class="" action="../konfirmasi/pembayaran" method="post">
                        <input type="hidden" name="idb" value="<?php echo $f17['id_pembayaran']; ?>">
                    ...
                    <div class="col-xs-6">
                    <form class="" action="../konfirmasi/hapuspembayaran" method="post">
                      <input type="hidden" name="idb" value="<?php echo $f17['id_pembayaran']; ?>">
